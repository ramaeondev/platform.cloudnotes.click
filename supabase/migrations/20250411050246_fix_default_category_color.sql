-- Update existing default categories that have 'none' as color
UPDATE public.categories 
SET color = '#FFFFFF' 
WHERE color = 'none';

-- Modify the handle_new_user function to use the correct default color
...
BEGIN
  ...
  -- Create a default category with a proper color that cannot be deleted
